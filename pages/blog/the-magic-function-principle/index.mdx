...
Fantastic job security aaaaand that's [why senior engineers get nothing done](https://swizec.com/blog/why-senior-engineers-get-nothing-done). There's no time. 💩
...
And oh my god it was beautiful. Cut through all the crap. You call this method, give it a user and an appointment, _and it does it all for you_. Standing on the right leg holding its left nostril and all! 😍
...
The Magic Function frees your team from that complexity. Instead of worrying about the details, they focus on _their_ problem. 🧙
...
The opposite of The Magic Function is the [unix philosophy](https://en.wikipedia.org/wiki/Unix_philosophy) – lots of small composable utilities.
